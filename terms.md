...
- **Optimization ledger:** `plans/summaries/optimizations.md`, which records compatible before/after artifact identities, measured latency/allocation changes, correctness checks, and whether an experiment was accepted, rejected, or reverted. Illustrative planning numbers are not evidence.
